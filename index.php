	...
	<div class="container px-4 max-w-6xl mx-auto my-8">
		<div class="w-full max-w-xl mx-auto">
			...
			<div class="LgnForm max-w-sm mx-auto  shadow-lg bg-white rounded-lg pt-6 pb-8 mb-4 px-8">
				...
				?>
				<form id="login_form" action="./views/process/dataProcess.php" method="POST">
					...
					<div class="MskForm">
						...
						<div class="flex items-center justify-between">
							...
							<a class="inline-block align-baseline font-bold text-sm text-blue-500 hover:text-blue-800" href="./views/auth/f_email.php">
								Forgot Password?
							</a>
						</div>
						<p class="mt-2 text-black-500 text-xs">
							Don't have an account, <a href="./views/auth/signup.php" class="text-black-700 font-bold">Create an account</a>.
						</p>
